...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        #self.radioButtonTG.clicked.connect(self.show_movers)
...
#                row[8].setText("")
        ...
        self.radioButton = QtWidgets.QRadioButton("Top Movers")
        self.radioButton.setToolTip("Open Top Movers window")
        #self.radioButtoners.clicked.connect(self.show_movers)
    ...
    def add_alert(self, txt):
        ...
        try:
            ...
            pct = 0
        item = QtWidgets.QListWidgetItem(txt)  # ← CORRECT
        if pct <= -5:
            item.setForeground(QtGui.QColor("#ff0033"))
            item.setBackground(QtGui.QColor(50, 0, 0))
        elif pct >= 5:
