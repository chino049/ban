...
# ----------------------------------------------------------------------
# Top Movers worker – reads symbols from the same file
# ----------------------------------------------------------------------
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        # ---- FLASHING ----
        self.semester_pct = {}          # sym → semester % (float)
        self.flash_state = False
        self.flash_timer = QtCore.QTimer()
        self.flash_timer.timeout.connect(self._flash_step)
        self.flash_timer.start(500)     # 0.5 s → 1 s full cycle
    ...
    def handle_wms(self, sym, w_d, w_p, m_d, m_p, s_d, s_p, h52, l52, price):
        ...
        for r in self.rows:
            ...
            # ---- NEW: remember semester % for flashing ----
            self.semester_pct[sym] = s_p
    ...
    def _flash_step(self):
        """Toggle black/white background for semester fields with |%|>20."""
        #print("-flash_step")
        self.flash_state = not self.flash_state
        target = QColor("white") if self.flash_state else QColor("black")

        for row in self.rows:
            # Safety: ensure row has enough elements
            if len(row) < 6:
            ...
            le_sem = row[5]  # Semester LineEdit
