...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    #         return
    #
    #     # CLEAR ALL OLD ALERTS BEFORE NEW SCAN
    #     if self.alert_win:
    ...
    #     if not self.stopped:
    #         self.progressBar.setRange(0, 1)
    #         self.timer.start(300_000)  # restart exactly after finish
    ...
    def price_done(self):
        if not self.stopped:
            ...
            if dtime(6, 0) <= now_est.time() <= dtime(13, 0):
                ...
                self.statusBar().showMessage("Market closed. Updates paused until 6 AM EST.")
    ...
    #         self.show_alerts()
    #
    #     # Extract the % change from the text (e.g. "ALERT: TSLA -6.82%!" → -6.82)
    #     try:
    #         pct_str = txt.split()[-1]  # gets "-6.82%!"
    ...
    #     item = QtWidgets.QListWidgetItem(txt)
    #     if pct <= -5:
    #         item.setForeground(QtGui.QColor("#ff0000"))  # BRIGHT RED
    #         item.setFont(QtGui.QFont("Arial", 10, QtGui.QFont.Bold))
    #     elif pct >= 5:
    #         item.setForeground(QtGui.QColor("#00ff00"))  # GREEN
    #         item.setFont(QtGui.QFont("Arial", 10, QtGui.QFont.Bold))
    #     else:
    #         item.setForeground(QtGui.QColor("#ffff00"))  # YELLOW for small moves
    #         item.setFont(QtGui.QFont("Arial", 9, QtGui.QFont.Bold))
    #
    #     # Optional: flash effect
    #     if abs(pct) >= 5:
    #         item.setBackground(QtGui.QColor(50, 0, 0) if pct < 0 else QtGui.QColor(0, 50, 0))
    #
    #     self.alert_win.lst.addItem(item)
    #     self.alert_win.lst.scrollToBottom()
